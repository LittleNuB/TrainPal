...
> 2026-09-11 发布暂停：下文保留历史竞赛记录，不表示当前线上状态或发布授权。当前仅允许个人仓库代码审查；镜像工作流改为手动、仅验证且不推送注册表，见 [ADR-0050](../adr/0050-code-review-does-not-publish-runtime-images.md)。恢复镜像发布、云端入口或部署均需另行明确批准。
